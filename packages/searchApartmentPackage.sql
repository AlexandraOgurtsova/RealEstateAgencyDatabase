...
create or replace package apartmentPackage as
   procedure apartment_in_district_arenda(districtP in varchar);
   procedure apartment_in_district_sale(districtP in varchar);
   procedure apartment_with_rooms_arenda(roomsP in number);
   procedure apartment_with_rooms_sale(roomsP in number);
   procedure apartment_square_more_arenda(squareP in number);
   procedure apartment_square_more_sale(squareP in number);
   procedure apartment_square_less_arenda(squareP in number);
   procedure apartment_square_less_sale(squareP in number);
   procedure apartment_year_more_arenda(yearP in number);
   procedure apartment_year_more_sale(yearP in number);
   procedure apartment_rooms_price_arenda(roomsP in number, sumP in number);
   procedure apartment_rooms_price_sale(roomsP in number, sumP in number);
   procedure apartment_search_arenda(roomsP in number, sumP in number, districtP in varchar, yearP in number);
   procedure apartment_search_sale(roomsP in number, sumP in number, districtP in varchar, yearP in number);
   procedure apartment_number(numberP in number);
end apartmentPackage;
   


create or replace package body apartmentPackage as
...
procedure apartment_in_district_arenda(districtP in varchar)
  ...
  end apartment_in_district_arenda;
...
------------найти все квартиры в районе на аренду 
 ...
 procedure apartment_in_district_sale(districtP in varchar)
  ...
  exception
    ...
    when others then
      dbms_output.put_line('Exception: '|| sqlerrm);
  end apartment_in_district_sale;
...
procedure apartment_with_rooms_arenda(roomsP in number)
  ...
  exception
    ...
    when others then
      dbms_output.put_line('Exception: '|| sqlerrm);
  end apartment_with_rooms_arenda;
...
procedure apartment_square_more_arenda(squareP in number)
  ...
  exception
    ...
    when others then
      dbms_output.put_line('Exception: '|| sqlerrm);
  end apartment_square_more_arenda;
...
procedure apartment_square_more_sale(squareP in number)
  ...
  exception
    ...
    when others then
      dbms_output.put_line('Exception: '|| sqlerrm);
  end apartment_square_more_sale;
...
procedure apartment_square_less_arenda(squareP in number)
  ...
  exception
    ...
    when others then
      dbms_output.put_line('Exception: '|| sqlerrm);
  end apartment_square_less_arenda;
...
procedure apartment_square_less_sale(squareP in number)
  ...
  exception
    ...
    when others then
      dbms_output.put_line('Exception: '|| sqlerrm);
  end apartment_square_less_sale;
...
procedure apartment_year_more_arenda(yearP in number)
  ...
  exception
    ...
    when others then
      dbms_output.put_line('Exception: '|| sqlerrm);
  end apartment_year_more_arenda;
...
procedure apartment_rooms_price_arenda(roomsP in number, sumP in number)
  ...
  exception
    ...
    when others then
      dbms_output.put_line('Exception: '|| sqlerrm);
  end apartment_rooms_price_arenda;
...
procedure apartment_rooms_price_sale(roomsP in number, sumP in number)
  ...
  exception
    ...
    when others then
      dbms_output.put_line('Exception: '|| sqlerrm);
  end apartment_rooms_price_sale;
...
procedure apartment_number(numberP in number)
  ...
  exception
    ...
    when others then
      dbms_output.put_line('Exception: '|| sqlerrm);
  end apartment_number;
  
end apartmentPackage;
  
begin
  apartmentPackage.apartment_number(56);
end;  