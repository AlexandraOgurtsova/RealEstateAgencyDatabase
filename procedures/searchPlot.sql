...
create or replace procedure plot_in_district_arenda(districtP in varchar)
  is
   rl realty%rowtype;
...
create or replace procedure plot_in_district_sale(districtP in varchar)
  is
   rl realty%rowtype;
   pl land_plot%rowtype;
   no_realty_error exception;
...
create or replace procedure plot_area_arenda(area1 in number, area2 in number)
  is
   id_realtyC number;
   id_ownerC number;
...
create or replace procedure plot_area_sale(area1 in number, area2 in number)
  is
   id_realtyC number;
   id_ownerC number;
   type_of_realtyC varchar(20);
...
create or replace procedure plot_search_arenda(districtP in varchar, area1 in number, area2 in number, priceP in number)
  is
   id_realtyC number;
   id_ownerC number;
   type_of_realtyC varchar(20);
...
create or replace procedure plot_search_sale(districtP in varchar, area1 in number, area2 in number, priceP in number)
  is
   id_realtyC number;
   id_ownerC number;
   type_of_realtyC varchar(20);
...
create or replace procedure plot_number(numberP in number)
  is
   id_realtyC number;
   id_ownerC number;
   type_of_realtyC varchar(20);
